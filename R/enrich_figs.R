...
rnaplots <- function(dds,pcut=0.05,fcut=2,folder=NULL,fprefix=NULL){
  ...
  if(!is.null(fprefix) & !is.null(folder)){
    ...
    ggplot2::ggsave(fname,plot=rres$endot,width=7,height=7,units='in')
    fname=glue::glue("./{folder}/{fprefix}_cnetfilt.png")
    ggplot2::ggsave(fname,plot=rres$cnetfilt,width=7,height=7,units='in')
    fname=glue::glue("./{folder}/{fprefix}_emap.png")
    ggplot2::ggsave(fname,plot=rres$emap,width=7,height=7,units='in')
    fname=glue::glue("./{folder}/{fprefix}_pca.png")
    ggplot2::ggsave(fname,plot=rres$pca,width=7,height=7,units='in')
    fname=glue::glue("./{folder}/{fprefix}_disp.png")
    ggplot2::ggsave(fname,plot=rres$disp,width=7,height=7,units='in')
    fname=glue::glue("./{folder}/{fprefix}_volc.png")
    ggplot2::ggsave(fname,plot=rres$volc,width=7,height=7,units='in')
    fname=glue::glue("./{folder}/{fprefix}_topgdot.png")
    ggplot2::ggsave(fname,plot=rres$topgdot,width=7,height=7,units='in')
